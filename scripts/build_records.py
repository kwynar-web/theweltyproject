...
M = {
 ...
 "H18 — Henry Welty estate partition case 224, heirs named, Stark Co OH Common Pleas 1850-51 (FamilySearch Appearance Dockets 1849-52 img262).jpg":
   (["E-henry"], "Partition of Henry Welty's real estate among his heirs — Stark Co. Ohio Common Pleas case #224, 'In Partition': William Welty (petitioner) v. George Welty, Henry Welty, David Welty, Nancy Welty (intermarried with John Stansbury), Susan Welty (intermarried with Walter Carr) & Jeremiah Grant; petition filed 23 Aug 1850, amicably settled 7 May 1851. Names six of Henry's children as heirs. FamilySearch, Stark Co. Appearance Dockets 1849–52, img 262 (ark 3QHV-V3D4-MSSQ).", "high"),
